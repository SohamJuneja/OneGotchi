  ...
  return (
    <div className="evolution-info">
      ...
      <div className="info-card">
        ...
        <p>Your OneGotchi evolves through 4 stages based on age, happiness, and hunger. Evolution happens automatically on-chain when conditions are met!</p>
      </div>
      ...
      <div className="mechanics-grid">
        ...
        <div className="mechanic-card">
          ...
          <ul>
            <li><strong>Feed</strong> (0.001 OCT): -40 hunger, +15 happiness</li>
      ...
      <div className="info-card tips">
        ...
        <ul>
          ...
          <li>Stats update based on OneChain's fast block times</li>
        </ul>
      </div>
      ...
      <div className="info-card technical">
        ...
        <p className="onechain-info">
          <strong>Optimized for OneChain:</strong> With high-speed blockchain performance, your pet experiences time 
