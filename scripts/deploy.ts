...
async function main() {
  console.log("🚀 Deploying OnePet to OneChain Testnet...\n");
  ...
  console.log("Account balance:", ethers.formatEther(balance), "OCT\n");
  ...
  console.log("\n🎉 Deployment complete!");
  console.log("🔗 View on OneChain Explorer (coming soon)");
  console.log("\n📝 Next steps:");
